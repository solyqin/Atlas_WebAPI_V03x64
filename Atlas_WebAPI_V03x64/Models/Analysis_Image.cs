...
namespace Atlas_WebAPI_V03x64.Models
{
    ...
    {
        private static DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new System.DateTime(1970, 1, 1)); // 当地时区
        ...
        private object picBaseInfo { set; get; }
        public object PicBaseInfo { get { return this.picBaseInfo; } }
